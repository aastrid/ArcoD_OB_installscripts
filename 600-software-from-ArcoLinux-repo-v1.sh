...
##SS sudo pacman -S arcolinux-arc-themes-nico-git --noconfirm --needed
...
##SS DENNA nedan KANSKE KAN VARA NGT ATT INSTALLERA där visas uppdateringar gjorda hos Erics ISO sudo pacman -S arcolinux-config-openbox-git --noconfirm --needed
...
##SS sudo pacman -S arcolinux-conky-collection-git --noconfirm --needed
...
##SS sudo pacman -S arcolinux-kvantum-git --noconfirm --needed
#sudo pacman -S arcolinux-kvantum-lxqt-git --noconfirm --needed
#sudo pacman -S arcolinux-kvantum-plasma-git --noconfirm --needed
##SS sudo pacman -S arcolinux-lightdm-gtk-greeter --noconfirm --needed
#sudo pacman -S arcolinux-lightdm-gtk-greeter-plasma --noconfirm --needed
##SS sudo pacman -S arcolinux-lightdm-gtk-greeter-settings --noconfirm --needed
...
##SS sudo pacman -S arcolinux-nitrogen-git --noconfirm --needed
...
##SS sudo pacman -S arcolinux-openbox-themes-git --noconfirm --needed
...
##SS sudo pacman -S arcolinux-polybar-git --noconfirm --needed
...
##SS sudo pacman -S arcolinux-tint2-git --noconfirm --needed
##SS sudo pacman -S arcolinux-tint2-themes-git --noconfirm --needed
##SS sudo pacman -S arcolinux-variety-git --noconfirm --needed
##SS sudo pacman -S arcolinux-wallpapers-git --noconfirm --needed
